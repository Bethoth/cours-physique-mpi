...
\newcommand{\paren}[1]{\biggl(#1\biggr)} % (x)
\newcommand{\croch}[1]{\biggl[#1\biggr]} % [x]
\newcommand{\accol}[1]{\biggl\lbrace#1\biggr\rbrace} % {x}
\newcommand{\abs}[1]{\biggl\lvert#1\biggr\rvert} % |x|
\newcommand{\norme}[1]{\biggl\|#1\biggr\|} % ||x||
\newcommand{\floor}[1]{\biggl\lfloor#1\biggr\rfloor} % ⌊x⌋
\newcommand{\ceil}[1]{\biggl\lceil#1\biggr\rceil} % ⌈x⌉

...
\include{meca/chap1_refs_ng/chap1_refs_ng.tex}

\include{meca/chap2_frott_solide/chap2_frott_solide}

\part{Optique}

\include{optique/chap1_modele_scal_ondes_lum/chap1_modele_scal_ondes_lum}

\include{optique/chap2_superposition_deux_ondes_lum/chap2_superposition_deux_ondes_lum}

\include{optique/chap3_interferometres_division_front_onde/chap3_interferometres_division_front_onde}

\include{optique/chap4_interferometres_division_amplitude/chap4_interferometres_division_amplitude}

\part{Électromagnétisme}

\include{electromag/formulaire_analyse_vectorielle/formulaire_analyse_vectorielle}

\include{electromag/chap1_electrostatique/chap1_electrostatique}

\include{electromag/chap2_topographie_champ_potentiel_electrostatiques/chap2_topographie_champ_potentiel_electrostatiques}

\include{electromag/chap3_dipole_electrostatique/chap3_dipole_electrostatique}

\include{electromag/chap4_magnetostatique/chap4_magnetostatique}

\include{electromag/chap5_dipole_magnetostatique/chap5_dipole_magnetostatique}

\include{electromag/chap6_eq_maxwell/chap6_eq_maxwell}

\include{electromag/chap7_energie_champ_electromagnetique/chap7_energie_champ_electromagnetique}

\include{electromag/chap8_onde_em_vide/chap8_onde_em_vide}

\include{electromag/chap9_onde_em_plasma/chap9_onde_em_plasma}

\include{electromag/chap10_onde_em_conducteur_ohmique/chap10_onde_em_conducteur_ohmique}

\include{electromag/chap11_rayonnement_dipole_oscillant/chap11_rayonnement_dipole_oscillant}

\part{Thermodynamique}

\include{thermo/chap1_transferts_thermiques/chap1_transferts_thermiques}

\part{Mécanique quantique}

\include{mecaQ/chap1_fonction_donde_eq_schrodinger/chap1_fonction_donde_eq_schrodinger}

\include{mecaQ/chap2_etats_particule_quantique_dans_potentiel_constant_par_morceaux/chap2_etats_particule_quantique_dans_potentiel_constant_par_morceaux}

\part{Chimie}

\include{chimie/chap1_transformations_chimiques/chap1_transformations_chimiques}

\include{chimie/chap2_reactions_acido-basiques/chap2_reactions_acido-basiques}

\include{chimie/chap3_reactions_oxydo-reduction/chap3_reactions_oxydo-reduction}

\part{Traitement du signal}

\include{traitement_signal/chap1_signaux_periodiques/chap1_signaux_periodiques}

\include{traitement_signal/chap2_logique_combinatoire/chap2_logique_combinatoire}

\include{traitement_signal/chap3_electronique_numerique/chap3_electronique_numerique}
\end{document}